...
BANK_ACCOUNT(BankID  VARCHAR(10) NOT NULL, 
            BANumber VARCHAR(10) NOT NULL, 
            CONSTRAINT BA_PK PRIMARY KEY (BankID, BANumber) );

CREATE TABLE IF NOT EXISTS
ELEC_ADDRESS(Identifier VARCHAR(30) NOT NULL, 
            Verified BIT, 
            Type CHAR(5), 
                CONSTRAINT EA_PK PRIMARY KEY (Identifier) );

CREATE TABLE IF NOT EXISTS
USER_ACCOUNT(SSN  CHAR(9) NOT NULL, 
            Name VARCHAR(40), 
            PhoneNo VARCHAR(10), 
...
CREATE TABLE IF NOT EXISTS
HAS_ADDITIONAL(SSN  CHAR(9) NOT NULL, 
...
CREATE TABLE IF NOT EXISTS
SEND_TRANSACTION (STid  CHAR(5) NOT NULL, 
                    Amount DECIMAL(10, 2), 
                    Date_Time TIMESTAMP, 
                    Memo VARCHAR(100), 
...
CREATE TABLE IF NOT EXISTS
EMAIL(EmailAdd VARCHAR(30) NOT NULL, 
        SSN CHAR(9), 
...
CREATE TABLE IF NOT EXISTS
REQUEST_TRANSACTION(RTid CHAR(5) NOT NULL, 
                    Amount DECIMAL(10, 2), 
                    Date_Time TIMESTAMP, 
                    Memo  VARCHAR(100), 
                    SSN CHAR(9), 
